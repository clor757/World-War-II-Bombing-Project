...
function drawLines() {  //----------------------------------
	...
	for (var  i= 0; i < data.length; i++) {
        ...
        L.circleMarker(destination, {
            ...
            color: "gray",
            fillOpacity: 0.3
        }).bindPopup(data[i]["Target City"] + ", " + data[i]["Target Country"])
            //.addTo(myMap)
            .on('mouseover', function (e) {
                this.openPopup()
            .on('mouseout', function (e) {
    ...
    // //create overlays
    // var overlayMaps = {
    // "Target Sites": targetLayer
    // //Overlay2: overlay2,
    // //Markers: groupedMarkers
    // };

    var targetLayer = L.layerGroup(targetMarkers);
...
var data;
Papa.parse('static/data/Flight_WWII_Test_Data_Filtered.csv', {
    header: true,
    download: true,
    dynamicTyping: true,
...
// circle1.bindPopup('<p>Hello world!<br />This is a nice popup.</p>');
